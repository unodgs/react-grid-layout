...
export function setTransform({top, left, width, height}: Position, fixed: boolean): Object {
...
export function setTopLeft({top, left, width, height}: Position, fixed: boolean): Object {
  return {
    top: `${top}px`,
    left: `${left}px`,
    width: `${width}px`,
